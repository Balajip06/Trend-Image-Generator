          ...
          {suggestions.map((s) => (
            ...
            >
              ...
              <div className="mt-4 flex gap-2">
                {/* TODO Phase 6 impl: server actions for approve → drafts trend row, reject → archives */}
                <button className="h-9 rounded-md bg-zinc-900 px-3 text-xs font-medium text-zinc-50 hover:bg-zinc-800 disabled:opacity-50 dark:bg-zinc-50 dark:text-zinc-900" disabled>
                  Approve → draft trend
                </button>
                <button className="h-9 rounded-md border border-zinc-200 px-3 text-xs font-medium text-zinc-700 hover:bg-zinc-50 disabled:opacity-50 dark:border-zinc-700 dark:text-zinc-300" disabled>
                  Reject
                </button>
              </div>
            </li>
